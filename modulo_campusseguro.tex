...
\InterfazFuncion{estudiantes}{\In{cs}{campusSeguro}}{itConj(nombre)}
[true]
...
\InterfazFuncion{hippies}{\In{cs}{campusSeguro}}{itConj(nombre)}
[true]
...
\InterfazFuncion{agentes}{\In{cs}{campusSeguro}}{itConj(agente)}
[true]
...
\InterfazFuncion{HippiesRodeadosAs}{\In{c}{conj(posición)}, \Inout{cs}{campusseguro}}{conj(nombre, posición}
...
\InterfazFuncion{DistanciaMasCorta}{\In{pos}{posicion}, \In{d}{dicString(nombre, posicion)}}{nat}
[\#Claves(d))>0]
...
\InterfazFuncion{hacerArregloMismasSanc}{\Inout{cs}{estr}}{}
[true]
...
\InterfazFuncion{busqBinAgente}{\In{k}{nat}, \Inout{i}{nat}, \In{v}{arreglo(puntero(kSanc))}}{bool}
[Longitud(v)>0]
