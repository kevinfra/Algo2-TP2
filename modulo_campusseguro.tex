...
\begin{Estructura}{campusSeguro}[estr]
	...
	\begin{Tupla}[datosAgente]
		...
		\tupItem{posMismasSanc}{itLista(mismasSanc)}%
		\tupItem{posConjMismasSanc}{itLista(mismasSanc.conjAgente)}%
	\end{Tupla}
...
\begin{lstlisting}[mathescape]
'\alg{iEstudiantes}{\In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iHippies}{\In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iAgentes}{\In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iPosEstudianteYHippie}{\In{id}{nombre}, \In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iPosAgente}{\In{a}{agente}, \In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iConMismasSanciones}{\In{a}{agente}, \In{cs}{campusSeguro} }{}'
...
\begin{lstlisting}[mathescape]
'\alg{iConKSanciones}{\In{n}{nat}, \In{cs}{campusSeguro} }{}'
