...
\begin{enumerate}
	...
	%TODO
	\item Todos los agentes que estan en el conjunto que tiene cada nodo de listaMismasSanc son validos.
	\item La interseccion de todos los conjuntos de cada nodo de listaMismasSanc genera el conjunto de claves de personalAS

	%TODO
	\item Cada agente valido tiene un iterador, itMismasSanc, que apunta al nodo de la lista listaMismasSanc que tiene la misma cantidad de sanciones que el agente, y otro iterador, itConjMismasSanc, que apunta si mismo en el conjunto agentes del nodo de listaMismasSanc que posee su misma cantidad de sanciones.
	...
	%TODO
	\item Los hippies de posicionesHippies son los mismos que hippies (de la estructura general) y viceversa.
	\item Los estudiantes de posicionesEstudiates son los mismos que estudiantes (de la estrctura general) y viceversa.
	\item Las posiciones en posicionesHippies que no tienen un hippie poseenel caracter de espacio " ".
